...
// APIClient manages communication with the World Anvil Public API Documentation API v2.0.0 - Boromir
...
type APIClient struct {
	...
	BlockFolderAPI *BlockFolderAPIService

	BlockTemplateAPI *BlockTemplateAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BlockFolderAPI = (*BlockFolderAPIService)(&c.common)
	c.BlockTemplateAPI = (*BlockTemplateAPIService)(&c.common)
